...
RENDISTR = [
    ...
    "`Badwoo ki yojna behan bna ke ch𓆘da uh iz badwa its your yozja?`",
    "`CHAND PE CHADA HAI CHANDYAAN KA GHODA TERA NAAM HAI MANSUR TU HAI BEHAN KA LOD𓆘??`",
    "`Jab se dil lga baithe tanhai me maa chu𓆘da baithe wo kho gyi kisi aur ke pyar hum apne hi jaato me aag lga baithe`",
...
INSULT_STRINGS = [
    ...
    "If you’re talking behind my back then you’re in a perfect position to kiss my a𓆘𓆘!.",
...
ABUSE_STRINGS = [
    ...
    "`Kahe Rahiman Kaviraaj C𓆘𓆘t Ki Mahima Aisi,L𓆘𓆘d Murjha Jaaye Par Ch𓆘𓆘t Waisi Ki Waisi`",
    "`Chudakkad Raand Ki Ch𓆘𓆘T Mein Pele L𓆘Nd Kabeer, Par Aisa Bhi Kya Choda Ki Ban Gaye Fakeer`",
]
GEY_STRINGS = [
    "`you gey bsdk`",
    "`you gey`",
...
FUK_STRINGS = [
    ...
    "`Pehle main tereko chakna dega, fir daru pilayega, fir jab aap dimag se nahi L𓆘nd se sochoge, tab bolega..`",
    "`Pardhan mantri se number liya, parliament apne :__;baap ka hai...`",
    "`Cachaa Ooo bhosdi wale Chacha`",
    "`Aaisi Londiya Chodiye, L𓆘nd Ka Aapa Khoye, Auro Se Chudi Na Ho, Biwi Wo Hi Hoye`",
    "`Nachoo Bhosdike Nachoo`",
    "`Jinda toh jaat ke baal bhi hai`",
    "`Sab ko pta tu randi ka baccha hai (its just a joke)`",
]
THANOS_STRINGS = [
    "`Mashoor Rand, Ne Arz Kiya Hai. Aane Wale Aate Hai, Jaane Wale Jaate Hai. Yaade Bas Unki Reh Jaati Hai, Jo G𓆘𓆘Nd Sujaa Ke Jaate Hai`",
    "`Pani kam hai matkey me ga𓆘d mardunga teri ek jatke me`",
    ...
    "`Uss Ne Hothon Se Chhu Kar Lowd𓆘 Pe Nasha Kar Diya; Lu𓆘D Ki Baat To Aur Thi, Uss Ne To Jhato𓆘 Ko Bhi Khada Kar Diya!`",
]
ABUSEHARD_STRING = [
