...
async def check_bot_started_users(user, event):
    ...
    if check is None:
        ...
        notification = f"👤 مستخدم جديد: {_format.mentionuser(user.first_name , user.id)}\
                \n𓆘𓆘الايدي: 𓆘𓆘`{user.id}`\
                \n𓆘𓆘الاسم: 𓆘𓆘{get_display_name(user)}"
    else:
...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("𓏺 𓆋 ســـورس آلَفــــرآعـــنه 𓆋 ˼", "https://t.me/wasit_go"),
                Button.url(
                    "مساعدة ❓",
                    "https://t.me/co_od",
                ),
        ...
        start_msg = "𓆘𓆘اهلا بك عزيزي مالك البوت هذه هي اعدادات البوت الخاصة بك𓆘𓆘"
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/wasit_go"),
            ],
            [
...
async def users(event):
    await event.delete()
    rorza = "𓆘𓆘▾∮ قائمه اوامر المطور 𓆘𓆘\n𓆘 تستخدم في ↫ `{BOT_USERNAME} ` فقط! `\n𓆘𓆘⍣ⵧⵧⵧⵧ ᥉ρᎥժᥱᖇ ⵧⵧⵧⵧ⍣𓆘𓆘\n\n𓆘الامر  ( اذاعة  ) \n- لعمل اذاعة لمستخدمي البوت ◛ ↶\n𓆘𓆘⋆ قم بالرد ع الرسالة لاذاعتها للمستخدمين ↸𓆘𓆘\n\n𓆘الامر ( ايدي ) \n- لمعرفة الملصقات المرسلة ↶\n𓆘𓆘⋆ بالرد ع المستخدم لجلب معلوماتة 𓆘𓆘\n\n𓆘الامر ( حظر + سبب )\n- لحظر مستخدم من البوت \n𓆘𓆘⋆ بالرد ع المستخدم مع سبب مثل 𓆘𓆘\n𓆘𓆘حظر @co_od قمت بازعاجي𓆘𓆘\n\n𓆘 الامر ( الغاء حظر ) \n لالغاء حظر المستخدم من البوت √\n𓆘𓆘⋆ الامر والمعرف والسبب (اختياري) مثل 𓆘𓆘\n𓆘𓆘الغاء حظر @co_od + السبب اختياري𓆘𓆘\n\n𓆘𓆘⋆ الامر ( المحظورين )\n- لمعرفة المحظورين من البوت  𓆘𓆘\n\n𓆘𓆘⋆ امر ( المستخدمين ) \n- لمعرفة مستخدمين بوتك  𓆘𓆘\n\n𓆘𓆘⋆ الاوامر ( التكرار + تفعيل / تعطيل ) \n- تشغيل وايقاف التكرار (في البوت) ↶𓆘𓆘\n𓆘 عند التشغيل يحظر المزعجين تلقائيًا ⊝\n\n𓆘𓆘⋆ امر ( تاك + الكلام ) \n- لعمل تاك للاعضاء يجب ااضافة البوت المساعد في المجموعة اولا و رفعه مشرف\n\n𓆘𓆘⋆ امر ( تنظيف ) \n- اضف البوت مشرف بعدها قم بالرد على اي رسالة واكتب تنظيف وسيقوم بحذف الرسائل التي تحتها\n\n⋆ امر ( مسح ) \n- اضف البوت مشرف بعدها قم بالرد على اي رسالة واكتب مسك وسيقوم بحذف الرسالة𓆘𓆘𓆘𓆘\n\n\n𓆘𓆘⍣ⵧⵧⵧⵧ ᥉ρᎥժᥱᖇ ⵧⵧⵧⵧ⍣𓆘𓆘\n𓏺 𓆋 ســـورس آلَفــــرآعـــنه 𓆋 ˼"
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if user_id is not None:
            try:
                ...
                return await event.reply(f"𓆘𓆘خطا:𓆘𓆘\n`{e}`")
            try:
                add_user_to_db(
...
async def bot_pms_edit(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if reply_msg := next(
            ...
            await event.client.send_message(
                Config.OWNER_ID,
                f"⬆️ 𓆘𓆘الرسالة في الاعلى تم تعديلها من قبل المستخدم𓆘𓆘 {_format.mentionuser(get_display_name(chat) , chat.id)} الى :",
                reply_to=reply_msg,
            )
            msg = await event.forward_to(Config.OWNER_ID)
            try:
        ...
        if users_1 is not None:
            ...
            try:
                if reply_msg:
                    ...
                    await event.client.send_message(
                        Config.OWNER_ID,
                        f"⬆️ 𓆘𓆘الرسالة هذه تم حذفها من قبل المستخدم𓆘𓆘 {_format.mentionuser(user_name , user_id)}.",
                        reply_to=reply_msg,
                    )
            except Exception as e:
                LOGS.error(str(e))
...
async def bot_start(event):
    ...
    if not reply_to:
        return await event.reply(
            "𓆘𓆘 يجب الرد على رسالة المستخدم التي تريد عرض معلوماته𓆘𓆘"
        )
    ...
    users = get_user_id(reply_to)
    if users is None:
        return await info_msg.edit("𓆘𓆘عذرا لم يتم العثور عليه في قاعدة البيانات𓆘𓆘")
    for usr in users:
        user_id = int(usr.chat_id)
        user_name = usr.first_name
        break
    ...
    if found:
        if flood_count >= FloodConfig.AUTOBAN:
            if user_.id in Config.SUDO_USERS:
                sudo_spam = (
                    f"𓆘𓆘المالك الثانوي𓆘𓆘 {_format.mentionuser(user_.first_name , user_.id)}:\n  الايدي: {user_.id}\n\n"
        ...
        try:
            ...
            await sbb_b.tgbot.send_message(
                Config.OWNER_ID,
                f"⚠️  𓆘𓆘[تحذير التكرار ](https://t.me/c/{chat.id}/{fa_msg.id})𓆘𓆘",
            )
        except UserIsBlockedError:
            if BOTLOG:
                await sbb_b.tgbot.send_message(BOTLOG_CHATID, "𓆘𓆘الغاء ححظر بوتك !𓆘𓆘")
...
async def bot_pm_ban_cb(c_q: CallbackQuery):
    ...
    try:
        ...
        await c_q.edit(f"✅ 𓆘𓆘تم بنجاح حظر المستخدم𓆘𓆘 ايدي المستخدم: {user_id}")
