        ...
        async with session.get(URL) as request:
            ...
            if sec_res.status_code == 200:
                ...
                for repo in sec_res.json():
                    ...
                    if limit == 0:
                        break
            REPLY = "𓆘𓆘✥ : معلومات الكيثهاب من𓆘𓆘 `{username}`\
                \n👤 𓆘𓆘✥ الاسم:𓆘𓆘 [{name}]({html_url})\
                \n🔧 𓆘𓆘✥ النوع:𓆘𓆘 `{type}`\
                \n🏢 𓆘𓆘✥ الشركة:𓆘𓆘 `{company}`\
                \n🔭 𓆘𓆘✥ المدونة𓆘𓆘 : {blog}\
                \n📍 𓆘𓆘✥ الموقع𓆘𓆘 : `{location}`\
                \n📝 𓆘𓆘✥ النبذة𓆘𓆘 : __{bio}__\
                \n❤️ 𓆘𓆘✥ المتابعون𓆘𓆘 : `{followers}`\
                \n👁 𓆘𓆘✥ الذين يتابعهم𓆘𓆘 : `{following}`\
                \n📊 𓆘𓆘✥ الريبوات العامة𓆘𓆘 : `{public_repos}`\
                \n📄 𓆘𓆘✥ الجماهير العامة𓆘𓆘 : `{public_gists}`\
                \n🔗 𓆘𓆘✥ تم إنشاء الملف الشخصي𓆘𓆘 : `{created_at}`\
                \n✏️ 𓆘𓆘✥ تم تحديث الملف الشخصي𓆘𓆘 : `{updated_at}`".format(
                username=username, 𓆘𓆘result
            )

            if repos:
                REPLY += "\n🔍 𓆘𓆘✥ بعض الريبوات𓆘𓆘 : " + " | ".join(repos)
...
@sbb_b.ar_cmd(
    ...
    info={
        ...
        "description": "It uploads the given file to your github repo in 𓆘𓆘sbb_b/plugins𓆘𓆘 folder\
