...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = (
        f"𓆘𓆘𓅽 قام مطورين السورس بتحديث الفراعنة 𓆘𓆘\n𓅽 𓆘𓆘التـغييرات\n𓆘𓆘 {changelog}"
    )
...
async def update(event, repo, ups_rem, ac_br):
    ...
    jasme = await event.edit(
        "𓆘𓆘𓅽 تم تحديث سورس الفراعنة  بنجاح انتظر قليلا سوف نخبرك بعد اعادة التشغيل !𓆘𓆘"
    )
...
async def upstream(event):
    ...
    event = await edit_or_reply(event, "𓆘𓆘𓅽 يـتـم البـحـث عـن تـحديثـات سـورس الفراعنة  انـتـظـر𓆘𓆘")
    ...
    if changelog == "" and not force_update:
        await event.edit(
            "𓆘𓆘𓅽 لا توجد تحديثات الى الان 𓆘𓆘\n"
        )
        return repo.__del__()
    if conf == "" and not force_update:
        ...
        return await event.respond(
            f"𓅽 لتحديث سورس الفراعنة  ارسل `.تحديث الان` "
        )
    ...
    if conf == "الان":
        await event.edit("𓆘𓆘𓅽 جار تحـديـث سـورس الفراعنة  انـتـظـر قـليـلا 🔨𓆘𓆘")
