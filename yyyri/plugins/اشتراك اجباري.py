...
async def fsub(event):
    ...
    try:
        ...
        channel = None
    if not channel:
        return await edit_delete(event, "𓆘𓆘-يجب عليك وضع معرف القناة اولا𓆘𓆘")
...
async def removefsub(event):
    ...
    await edit_or_reply(event, "𓆘𓆘- تم بنجاح تعطيل الاشتراك الاجباري في هذه المجموعة𓆘𓆘")
