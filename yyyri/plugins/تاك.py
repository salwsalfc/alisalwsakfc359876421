...
@sbb_b.on(admin_cmd(pattern="تاك 200(?: |$)(.𓆘)"))
async def iq(sbb_b):
    ...
    await sbb_b.delete()
@sbb_b.on(admin_cmd(pattern="تاك 150(?: |$)(.𓆘)"))
async def iq(sbb_b):
    mentions = sbb_b.text[8:]
    chat = await sbb_b.get_input_chat()
    ...
    await sbb_b.client.send_message(sbb_b.chat_id, mentions)
    await sbb_b.delete()
@sbb_b.on(admin_cmd(pattern="تاك 100(?: |$)(.𓆘)"))
async def iq(sbb_b):
    mentions = sbb_b.text[8:]
    chat = await sbb_b.get_input_chat()
    ...
    await sbb_b.client.send_message(sbb_b.chat_id, mentions)
    await sbb_b.delete()
@sbb_b.on(admin_cmd(pattern="تاك 50(?: |$)(.𓆘)"))
async def iq(sbb_b):
    mentions = sbb_b.text[8:]
    chat = await sbb_b.get_input_chat()
    ...
    await sbb_b.client.send_message(sbb_b.chat_id, mentions)
    await sbb_b.delete()
@sbb_b.on(admin_cmd(pattern="تاك 10(?: |$)(.𓆘)"))
async def iq(sbb_b):
    mentions = sbb_b.text[8:]
    chat = await sbb_b.get_input_chat()
