...
async def who(event):
    ...
    try:
        ...
        return await edit_or_reply(zed, "𓆘𓆘𓅄 لـم استطـع العثــور ع الشخــص𓆘𓆘")
    if replied_user.id in zel_dev:
       return await edit_or_reply(zed, "𓆘𓆘𓅄 دي . . انـهُ احـد المطـورين . . انتـه الحيـوان ولك𓆘𓆘")
    if replied_user.id == 5656828413 or replied_user.id == 5680297831 or replied_user.id == 5680297831:
       return await edit_or_reply(zed, "𓆘𓆘𓅄 دي . . انـهُ المطـور . . انتـه الحيـوان ولك𓆘𓆘")
