...
from razan.CMD.aomari import 𓆘

ROE = "𓆘𓆘 هـذه هي قائمة اوامـر سـورس الفراعنة 𓆘𓆘"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("الاوامر ") and event.query.user_id == sbb_b.uid:
            buttons = [
                [Button.inline("معلومات الفراعنة ", data="AOMRDB")],
                [
...
اوامر فارات سورس الفراعنة @wasit_go""",
        buttons=[
...
𓆘يمكنك استخدا الزخرفة او اللغة الانكليزية او العربية الخ..

𓆘 كيفية جلب رابط الصورة؟
...
𓆘 يمكنك كتابة اي كليشة مثلا: عزيزي المستخدم تم حظرك 
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس الفراعنة @wasit_go""",
        buttons=[
...
𓆘 يمكنك الحصول على  كليشة جاهزة من هذه القناة @wasit_go
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس الفراعنة @wasit_go""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
...
𓆘 كيفية جلب رابط الصورة؟
-بالرد على الصورة المراد استخراج منها الرابط ب  `.تلكراف ميديا`
ملاحظة : 𓆘𓆘يمكنك استخدام الاوامر في اي دردشة او محادثة𓆘𓆘
اوامر فارات سورس الفراعنة @wasit_go""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
        ],
