...
async def _(event):
    ...
    animation_chars = [
        "𓆘𓆘Heroku Connecting To Latest Github Build 𓆘𓆘",
        f"𓆘𓆘Build started by user𓆘𓆘 {mention}",
        f"𓆘𓆘Deploy𓆘𓆘 `535a74f0` 𓆘𓆘by user𓆘𓆘 {mention}",
        "𓆘𓆘Restarting Heroku Server...𓆘𓆘",
        "𓆘𓆘State changed from up to starting𓆘𓆘",
        "𓆘𓆘Stopping all processes with SIGTERM𓆘𓆘",
        "𓆘𓆘Process exited with𓆘𓆘 `status 143`",
        "𓆘𓆘Starting process with command𓆘𓆘 `python3 -m sbb_b`",
        "𓆘𓆘State changed from starting to up𓆘𓆘",
        ...
        [
            ...
            for y in (
                [
                    "".join(x)
                    for x in (
                        f + (s, g, s + s 𓆘 f.count(""), t),
                        f + (g, s 𓆘 2 + s 𓆘 f.count(""), t),
                        f[:i] + (o, f[i], s 𓆘 2 + s 𓆘 f.count(""), t),
                        f[:i] + (s + s 𓆘 f.count(""), o, f[i], s, t),
                        f[:i] + (s 𓆘 2 + s 𓆘 f.count(""), o, f[i], t),
                        f[:i] + (s 𓆘 3 + s 𓆘 f.count(""), o, t),
                        f[:i] + (s 𓆘 3 + s 𓆘 f.count(""), g, t),
                    )
                ]
