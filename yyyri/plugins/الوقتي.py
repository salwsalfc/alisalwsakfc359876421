...
async def _(event):
    ...
    if gvarstatus("digitalpic") is not None and gvarstatus("digitalpic") == "true":
        return await edit_delete(event, "𓆘𓆘- الصورة الوقتية بالاصل شغالة𓆘𓆘")
    addgvar("digitalpic", True)
    await edit_delete(event, "𓆘𓆘- تم بنجاح تفعيل امر الصورة الوقتية بنجاح𓆘𓆘")
...
async def _(event):
    if gvarstatus("autoname") is not None and gvarstatus("autoname") == "true":
        return await edit_delete(event, "𓆘𓆘- الاسم الوقتي بالاصل شغال")
    addgvar("autoname", True)
    await edit_delete(event, "𓆘𓆘- تم تفعيل الاسم الوقتي بنجاح𓆘𓆘")
    await autoname_loop()
...
async def _(event):
    if gvarstatus("autobio") is not None and gvarstatus("autobio") == "true":
        return await edit_delete(event, "𓆘𓆘- البايو الوقتي بالاصل شغال𓆘𓆘")
    addgvar("autobio", True)
    await edit_delete(event, "𓆘𓆘- تم بنجاح تشغيل البايو الوقتي𓆘𓆘")
    await autobio_loop()


@sbb_b.ar_cmd(pattern="انهاء ([\s\S]𓆘)")
async def _(event):
    ...
    if (
        ...
        if gvarstatus("digitalpic") is not None and gvarstatus("digitalpic") == "true":
            ...
            return await edit_delete(event, "𓆘𓆘- تم بنجاح ايقاف الصورة الوقتية𓆘𓆘")
        return await edit_delete(event, "𓆘𓆘- الصورة الوقتية غير مفعلة بالاصل𓆘𓆘")
    if (
        input_str == "اسم وقتي"
        ...
        if gvarstatus("autoname") is not None and gvarstatus("autoname") == "true":
            ...
            return await edit_delete(event, "𓆘𓆘- تم بنجاح ايقاف الاسم الوقتي𓆘𓆘")
        return await edit_delete(event, "𓆘𓆘- الاسم الوقتي غير شغال اصلا𓆘𓆘")
    if input_str == "بايو وقتي" or input_str == "البايو الوقتي":
        if gvarstatus("autobio") is not None and gvarstatus("autobio") == "true":
            ...
            return await edit_delete(event, "𓆘𓆘- تم بنجاح ايقاف البايو الوقتي𓆘𓆘")
        return await edit_delete(event, "𓆘𓆘- البايو الوقتي غير شغال اصلا𓆘𓆘")
    END_CMDS = [
        "الصورة الوقتية",
        "الصورة الوقتيه",
        "الصوره الوقتيه",
