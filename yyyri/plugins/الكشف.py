...
@sbb_b.ar_cmd(pattern="ايدي(?: |$)(.𓆘)")
async def who(event):
    roz = await edit_or_reply(event, "𓆘𓆘⌔∮ جار التعرف على المستخدم انتظر قليلا𓆘𓆘")
    ...
    try:
        ...
        return await edit_or_reply(roz,  "𓆘𓆘⌔∮ لم يتم العثور على معلومات لهذا المستخدم 𓆘𓆘")
...
@sbb_b.ar_cmd(pattern="رابط الحساب(?:\s|$)([\s\S]𓆘)")
