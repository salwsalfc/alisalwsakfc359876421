...
bg_url_1 = "https://raw.githubusercontent.com/sbb_b/Jmthon-Resources/master/Resources/App/app-full.jpg"
bg_url_2 = "https://raw.githubusercontent.com/sbb_b/Jmthon-Resources/master/Resources/App/app-suggest.jpg"
...
@sbb_b.ar_cmd(pattern="تطبيق ([\s\S]𓆘)")
async def app_search(event):
    query = event.pattern_match.group(1)
    if not query:
        return await edit_delete(event, "𓆘𓆘▿∲ اكتب اسم التطبيق للبحث عنه في جوجل بلاي𓆘𓆘")
    ...
    try:
        ...
        return await edit_delete(event, "𓆘𓆘▿∲ يجب عليك كتابة عنوان صالح و صحيح𓆘𓆘")
