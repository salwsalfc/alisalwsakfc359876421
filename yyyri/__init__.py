...
__author__ = "سورس الفراعنة  <https://github.com/sourcesemsem/PYROGRAM>"
__copyright__ = f" حقوق سورس الفراعنة  (C) 2020 - 2022  {__author__}"

sbb_b.version = __version__
sbb_b.tgbot.version = __version__
LOGS = logging.getLogger("سورس الفراعنة ")
bot = sbb_b
tbot = tgbot
...
def close_connection(*_):
    print("تم اغلاق الاتصال بالسورس الفراعنة ")
